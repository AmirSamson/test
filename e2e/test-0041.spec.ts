...
test('test', async () => {
  ...
  await page.waitForTimeout(5000);
    ...
    // Click text=نمایش بیشتر
    await page.locator('text=نمایش بیشتر').click();

  
  await page.locator('.sc-bOtlzW').screenshot({path:'./test/screenshots/test.profile.41.test.ts.jpg'});
