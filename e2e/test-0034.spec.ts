...
test('test', async ({ page }) => {
  ...
  // Click text=.st0{fill:#303134;} .st1{opacity:0.8;} .st2{fill:#FFFFFF;} با حمایت ما را در ادا >> a
  ...
  await page.screenshot({path:'./test/screenshots/test.profile.34.test.ts.jpg'});
